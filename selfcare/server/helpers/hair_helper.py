...
dlr.download("damaged hair", limit = 1000, output_dir='images')
dlr.download("dry hair", limit = 1000, output_dir='images')
dlr.download("brittle hair", limit = 1000, output_dir='images')
dlr.download("dry crunchy hair", limit = 1000, output_dir='images')
dlr.download("crunchy hair", limit = 1000, output_dir='images')
dlr.download("oily hair", limit = 1000, output_dir='images')
dlr.download("oily scalp", limit = 1000, output_dir='images')
dlr.download("dry scalp", limit = 1000, output_dir='images')
